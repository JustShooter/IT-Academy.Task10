...
public class RepositoryService {
    ...
    public Student createNewStudentEntity(String studentName, String studentSurname) {
        if (getStudentIdByFullName(studentName, studentSurname) == null) {
    ...
    public Mentor createNewMentorEntity(String mentorName, String mentorSurname) {
        if (getMentorIdByFullName(mentorName, mentorSurname) == null) {
    ...
    public Course createCourseEntity(String courseTitle) {
        if (getCourceIdByTitle(courseTitle) == null) {
